...
public class JobMain extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        //2:对job任务进行配置(八个步骤)
            ...
            TextInputFormat.addInputPath(job, new Path("C:\\Users\\LENOVO\\IdeaProjects\\mapreduce\\data\\partition.csv"));
            ...
            TextOutputFormat.setOutputPath(job, new Path("C:\\Users\\LENOVO\\IdeaProjects\\mapreduce\\data\\result001_out"));
